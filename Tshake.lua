...
sudo_users = {sudo_add,bot_id,414421601,266057334}
...
function is_doq(msg)
local hash = database:sismember('Tshake:'..bot_id..'doq:'..msg.chat_id_,msg.sender_user_id_) 
...
local hash = database:sismember('Tshake:'..bot_id..'sakl:'..msg.chat_id_,msg.sender_user_id_) 
if hash or is_devzain(msg) or is_sudo(msg) or is_creatorbasic(msg) or is_creatorbasicc(msg.chat_id_,msg.sender_user_id_) or is_creator(msg) or is_owner(msg) or is_mod(msg) then    
return true 
else 
return false 
...
local hash = database:sismember('Tshake:'..bot_id..'donke:'..msg.chat_id_,msg.sender_user_id_) 
if hash or is_devzain(msg) or is_sudo(msg) or is_creatorbasic(msg) or is_creatorbasicc(msg.chat_id_,msg.sender_user_id_) or is_creator(msg) or is_owner(msg) or is_mod(msg) then    
return true 
else 
return false 
...
local hash = database:sismember('Tshake:'..bot_id..'zahf:'..msg.chat_id_,msg.sender_user_id_) 
if hash or is_devzain(msg) or is_sudo(msg) or is_creatorbasic(msg) or is_creatorbasicc(msg.chat_id_,msg.sender_user_id_) or is_creator(msg) or is_owner(msg) or is_mod(msg) then    
return true 
else 
return false 
...
local hash = database:sismember('Tshake:'..bot_id..'zain:'..msg.chat_id_,msg.sender_user_id_) 
if hash or is_devzain(msg) or is_sudo(msg) or is_creatorbasic(msg) or is_creatorbasicc(msg.chat_id_,msg.sender_user_id_) or is_creator(msg) or is_owner(msg) or is_mod(msg) then    
return true 
else 
return false 
...
{
{text = ''..(channel_ts or "TshAkE TEAM")..'', url=''..(channel_user_ts or 't.me/Spirta')..''},
},
}
...
info = '👤┇بواسطه ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'Tshake')..')\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(msg.sender_user_id_, zain333)
end
if value == "prore" then
function get_TshakeX(Spirtax1,Spirtax2,Spirtax3)
local id_Tshakex = Spirtax2.sender_user_id_
function zain333(extra,result,success)
if result.first_name_ then
if #result.first_name_ < 15 then 
else
...
info = '👤┇العضو ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'Tshake')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(id_Tshakex, zain333)
end
...
info = '👤┇العضو ~⪼ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'Tshake')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
local Spirtaee = dofile("files_Tshake/"..files_Tshake[i])
...
local kt = Spirtaee.zain_Tshake(data)
if kt == 'end' then
return false
end
end
...
local list = redis:smembers('Tshake:'..bot_id..'sudo:zainre')
...
redis:del('Tshake:'..bot_id..'sudo:zainre')
end
...
local zain1 = redis:get('Tshake:'..bot_id..'sudo:zain1'..msg.sender_user_id_..''..msg.chat_id_..'')
local test = redis:get('Tshake:'..bot_id..'sudo:msg'..msg.sender_user_id_..''..msg.chat_id_..'')
if zain1 == 're' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الرد', 1, 'md')
redis:set('Tshake:'..bot_id..'sudo:zain1'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
...
redis:set('Tshake:'..bot_id..'sudo:zain1'..msg.sender_user_id_..''..msg.chat_id_..'', 're')
...
redis:sadd('Tshake:'..bot_id..'sudo:zainre', text)
return false end
end
if text and text:match("^(.*)$") then
local zain1 = redis:get('Tshake:'..bot_id..'sudo:zain1'..msg.sender_user_id_..''..msg.chat_id_..'')
...
redis:del('Tshake:'..bot_id.."sudo:addreply1:document:gp"..text)
redis:del('Tshake:'..bot_id.."sudo:addreply1:audio:gp"..text)
redis:del('Tshake:'..bot_id..'sudo:zain1'..msg.sender_user_id_..''..msg.chat_id_..'')
redis:srem('Tshake:'..bot_id..'sudo:zainre', text)
return false
end
end
if text == 'اضف رد للكل' and is_devzain(msg) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد اضافتها ', 1, 'md')
redis:set('Tshake:'..bot_id..'sudo:zain1'..msg.sender_user_id_..''..msg.chat_id_..'', 'msg')
return false 
end
if text == 'حذف رد للكل' and is_devzain(msg) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد حذفها ', 1, 'md')
redis:set('Tshake:'..bot_id..'sudo:zain1'..msg.sender_user_id_..''..msg.chat_id_..'', 'nomsg')
return false 
end
...
local list = redis:smembers('Tshake:'..bot_id..'zainre'..msg.chat_id_..'')
for k,v in pairs(list) do
...
redis:del('Tshake:'..bot_id..'zainre'..msg.chat_id_..'')
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local zain1 = redis:get('Tshake:'..bot_id..'zain1'..msg.sender_user_id_..''..msg.chat_id_..'')
local test = redis:get('Tshake:'..bot_id..'msg'..msg.sender_user_id_..''..msg.chat_id_..'')
if zain1 == 're' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الرد', 1, 'md')
redis:set('Tshake:'..bot_id..'zain1'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
if msg.content_.sticker_ then   
...
if zain1 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل الرد الذي تريد اضافته \n📥┇ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات  ', 1, 'md')
redis:set('Tshake:'..bot_id..'zain1'..msg.sender_user_id_..''..msg.chat_id_..'', 're')
...
redis:sadd('Tshake:'..bot_id..'zainre'..msg.chat_id_..'', text)
return false end
end
if text and text:match("^(.*)$") then
local zain1 = redis:get('Tshake:'..bot_id..'zain1'..msg.sender_user_id_..''..msg.chat_id_..'')
...
redis:del('Tshake:'..bot_id.."addreply1:document:gp"..text..msg.chat_id_)
redis:del('Tshake:'..bot_id.."addreply1:audio:gp"..text..msg.chat_id_)
redis:del('Tshake:'..bot_id..'zain1'..msg.sender_user_id_..''..msg.chat_id_..'')
redis:srem('Tshake:'..bot_id..'zainre'..msg.chat_id_..'', text)
return false
end
end
if text == 'اضف رد' and is_owner(msg) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد اضافتها ', 1, 'md')
redis:set('Tshake:'..bot_id..'zain1'..msg.sender_user_id_..''..msg.chat_id_..'', 'msg')
return false 
end
if text == 'حذف رد' and is_owner(msg) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد حذفها ', 1, 'md')
redis:set('Tshake:'..bot_id..'zain1'..msg.sender_user_id_..''..msg.chat_id_..'', 'nomsg')
return false 
end
...
for i=1, #gpss do
tdcli.sendPhoto(gpss[i], 0, 0, 1, nil, id_zain,(msg.content_.caption_ or " "))		
database:set('Tshake:'..bot_id..'Msg_Text'..gpss[i],id_zain) 
end
end
gpss = database:smembers( 'Tshake:'..bot_id.."groups") or 0
send(msg.chat_id_, msg.id_, 1, '☑┇تم نشر الرساله في {'..(#gpss)..'} مجموعه ', 1, 'md')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local zain2 = redis:get('Tshake:'..bot_id..'texts'..msg.sender_user_id_..'')
if zain2 == 'msg' then
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local zain2 = redis:get('Tshake:'..bot_id..'textst'..msg.sender_user_id_..'')
if zain2 == 'msg' then
...
------------------------------------------------------------------------
if text and text:match("^+(.*)$") then
local zaino = redis:get('Tshake:'..bot_id..'sudoo'..text..'')
local zain2 = redis:get('Tshake:'..bot_id..'nzain'..msg.sender_user_id_..'')
if zain2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '• `الان يمكنك ارسال الاسم الذي تريده` 🏷', 1, 'md')
redis:set('Tshake:'..bot_id..'nmzain', text)
redis:set('Tshake:'..bot_id..'nzain'..msg.sender_user_id_..'', 'mmsg')
return false 
end
end
------------------------------------------------------------------------
...
redis:set('Tshake:'..bot_id..'nzain'..msg.sender_user_id_..'', 'no')
redis:set('Tshake:'..bot_id..'nazain', text)
local nmzain = redis:get('Tshake:'..bot_id..'nmzain')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local zain2 = redis:get('Tshake:'..bot_id..'h44'..msg.sender_user_id_..'')
if zain2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local zain2 = redis:get('Tshake:'..bot_id..'h33'..msg.sender_user_id_..'')
if zain2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local zain2 = redis:get('Tshake:'..bot_id..'h22'..msg.sender_user_id_..'')
if zain2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local zain2 = redis:get('Tshake:'..bot_id..'h11'..msg.sender_user_id_..'')
if zain2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local zain2 = redis:get('Tshake:'..bot_id..'hhh'..msg.sender_user_id_..'')
if zain2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
local zain2 = redis:get('Tshake:'..bot_id..'hres1'..msg.sender_user_id_..'')
if zain2 == 'msg' then
if text:match("^(.*)$") then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
local zain = database:get('Tshake:'..bot_id.."filtr1:add:reply:rd"..text..msg.chat_id_)   
if zain then    
function get_info(arg,data)
if data.username_ ~= false then
send(msg.chat_id_,0, 1, "⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛┇["..zain.."] \n" , 1, 'md') 
else
send(msg.chat_id_,0, 1, "⚠┇العضو : {["..data.first_name_.."](T.ME/Spirta)}\n📛┇["..zain.."] \n" , 1, 'md') 
end
end
...
send(msg.chat_id_,0, 1, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/Spirta)}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" , 1, 'md') 
end
end
getUser(msg.sender_user_id_,get_info)
delete_msg(msg.chat_id_,{[0] = msg.id_})       
...
if text and (text:match("[Hh][Tt][Tt][Pp][Ss]://") or text and text:match("[Jj][Oo][Ii][Nn][Cc][Hh][Aa][Tt]")  or text and text:match("[Hh][Tt][Tt][Pp]://") or text and text:match(".[Ii][Rr]") or text and text:match(".[Cc][Oo][Mm]") or text and text:match(".[Oo][Rr][Gg]") or text and text:match(".[Ii][Nn][Ff][Oo]") or text and text:match("[Ww][Ww][Ww].") or text and text:match(".[Tt][Kk]")) then
if database:get("lock_link:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
...
if text and (text:match("[Hh][Tt][Tt][Pp][Ss]://") or text and text:match("[Jj][Oo][Ii][Nn][Cc][Hh][Aa][Tt]")  or text and text:match("[Hh][Tt][Tt][Pp]://") or text and text:match(".[Ii][Rr]") or text and text:match(".[Cc][Oo][Mm]") or text and text:match(".[Oo][Rr][Gg]") or text and text:match(".[Ii][Nn][Ff][Oo]") or text and text:match("[Ww][Ww][Ww].") or text and text:match(".[Tt][Kk]")) then
if database:get("lock_link:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
chat_kick(msg.chat_id_, msg.sender_user_id_)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇الروابط  تم قفلها ممنوع ارسالها\n☑┇تم طردك من المجموعه", 1, 'html')
return false   
end    
end
---------------------------------Tm---------------------------------------
...
if text and text:match("(.*)(@)(.*)")  then
if database:get("lock_username:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇المعرف  تم قفلها ممنوع ارسالها", 1, 'html')
return false   
end    
end
if text and text:match("(.*)(@)(.*)")  then
if database:get("lock_username:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if text and text:match("(.*)(/)(.*)")  then
if database:get("lock_sarha:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if text and text:match("(.*)(/)(.*)")  then
if database:get("lock_sarha:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
chat_kick(msg.chat_id_, msg.sender_user_id_)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇الشارحه  تم قفلها ممنوع ارسالها\n☑┇تم طردك من المجموعه", 1, 'html')
return false   
end    
end
-----------------------------------------Tm-------------------------------
...
if text and text:match("(.*)(#)(.*)")  then
if database:get("lock_tag:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇التاك تم قفلها ممنوع ارسالها", 1, 'html')
return false   
end    
end
if text and text:match("(.*)(#)(.*)")  then
if database:get("lock_tag:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if msg.content_.ID == "MessageForwardedFromUser" then
if database:get("lock_fwd:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if msg.content_.ID == "MessageForwardedFromUser" then
if database:get("lock_fwd:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
chat_kick(msg.chat_id_, msg.sender_user_id_)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇التوجيه تم قفلها ممنوع ارسالها\n☑┇تم طردك من المجموعه", 1, 'html')
return false   
end    
end
-------------------------------------------Tm-----------------------------
...
if msg.content_.ID == "MessageSticker" then
if database:get("lock_stecker:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if msg.content_.ID == "MessageSticker" then
if database:get("lock_stecker:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
chat_kick(msg.chat_id_, msg.sender_user_id_)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇الملصقات تم قفلها ممنوع ارسالها\n☑┇تم طردك من المجموعه", 1, 'html')
return false   
end    
end
------------------------------------------------------------------------
...
if msg.content_.ID == "MessagePhoto" then
if database:get("lock_photo:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if msg.content_.ID == "MessagePhoto" then
if database:get("lock_photo:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if msg.content_.ID == "MessageAudio" then
if database:get("lock_audeo:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇الصوت تم قفلها ممنوع ارسالها", 1, 'html')
return false   
end    
end
if msg.content_.ID == "MessageAudio" then
if database:get("lock_audeo:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if msg.content_.ID == "MessageVoice" then
if database:get("lock_voice:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if msg.content_.ID == "MessageVoice" then
if database:get("lock_voice:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if msg.content_.ID == "MessageVideo" then
if database:get("lock_video:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇الفيديو تم قفلها ممنوع ارسالها", 1, 'html')
return false   
end    
end
if msg.content_.ID == "MessageVideo" then
if database:get("lock_video:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
chat_kick(msg.chat_id_, msg.sender_user_id_)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇الفيديو تم قفلها ممنوع ارسالها\n☑┇تم طردك من المجموعه", 1, 'html')
return false   
end    
end
----------------------------------------------Tm--------------------------
...
if msg.content_.ID == "MessageAnimation" then
if database:get("lock_gif:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇المتحركه تم قفلها ممنوع ارسالها", 1, 'html')
return false   
end    
end
if msg.content_.ID == "MessageAnimation" then
if database:get("lock_gif:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
chat_kick(msg.chat_id_, msg.sender_user_id_)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇المتحركه تم قفلها ممنوع ارسالها\n☑┇تم طردك من المجموعه", 1, 'html')
return false   
end    
end
-------------------------------------Tm-----------------------------------
...
if msg.content_.ID == "MessageContact" then
if database:get("lock_contact:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇الجهات تم قفلها ممنوع ارسالها", 1, 'html')
return false   
end    
end
if msg.content_.ID == "MessageContact" then
if database:get("lock_contact:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if text and text:match("[\216-\219][\128-\191]") then
if database:get("lock_ar:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇العربيه تم قفلها ممنوع ارسالها", 1, 'html')
return false   
end    
end
if text and text:match("[\216-\219][\128-\191]") then
if database:get("lock_ar:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
chat_kick(msg.chat_id_, msg.sender_user_id_)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇العربيه تم قفلها ممنوع ارسالها\n☑┇تم طردك من المجموعه", 1, 'html')
return false   
end    
end
----------------------------------------Tm--------------------------------
...
if msg.content_.ID == "MessageDocument" then
if database:get("lock_files:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if msg.content_.ID == "MessageDocument" then
if database:get("lock_files:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
...
if text and text:match("[ASDFGHJKLQWERTYUIOPZXCVBNMasdfghjklqwertyuiopzxcvbnm]") then
if database:get("lock_en:wern"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇الانكليزيه تم قفلها ممنوع ارسالها", 1, 'html')
return false   
end    
end
if text and text:match("[ASDFGHJKLQWERTYUIOPZXCVBNMasdfghjklqwertyuiopzxcvbnm]") then
if database:get("lock_en:ban"..msg.chat_id_..bot_id) then
local id = msg.id_
local msgs = {[0] = id}
local chat = msg.chat_id_
local user_id = msg.sender_user_id_
delete_msg(chat,msgs)
chat_kick(msg.chat_id_, msg.sender_user_id_)
send(msg.chat_id_, 0, 1, "🎫┇الايدي ~⪼ ("..msg.sender_user_id_..") \n❕┇الانكليزيه تم قفلها ممنوع ارسالها\n☑┇تم طردك من المجموعه", 1, 'html')
return false   
end    
end
------------------------------------------------------------------------
...
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=GLOBLA&user_id="..msg.sender_user_id_);
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/Spirtabot/files_Tshake/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Spirtabot/files_Tshake/master/files_Tshake/"..file)
if res == 200 then
...
local hash =  'Tshake:'..bot_id..'gbanned:'
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apbll[2] or 'Tshake')..')\n🚫┇تم حظره من المجموعات البوت'
...
local hash =  'Tshake:'..bot_id..'gbanned:'
if result.id_ then
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apid[2] or 'Tshake')..')\n��┇تم الغاء حظره من المجموعات البوت'
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Tshake')..')\n\n☑┇تم رفعة مطور في البوت'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
os.execute('rm -rf Spirta.lua')
os.execute('cd libs;wget https://raw.githubusercontent.com/Spirtabot/Spirta/master/libs/utils.lua')
os.execute('wget https://raw.githubusercontent.com/Spirtabot/Spirta/master/Spirta.lua')
dofile('Tshake.lua')  
return false
end
...
f:write(text233)
f:close()
local Spirtae = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
local curl = 'curl "' .. Spirtae .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'TshAkE.txt' .. '"'
io.popen(curl)
end
...
redis:set('Tshake:'..bot_id..'nzain'..msg.sender_user_id_..'', 'msg')
return false 
end
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apow[2] or 'Tshake')..')\n☑┇تم رفعة منشئ  في البوت'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
local tsX_o = database:get("lock_edit:Spirta:kick"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل التعديل بالطرد")
else
tsX000("lock",msg,"🔐┇تم قفل التعديل بالطرد")
database:set("lock_edit:Spirta:kick"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_edit:Spirta:kick"..msg.chat_id_..bot_id,"ok")
end
end
...
database:set('Tshake:'..bot_id..'gamepoint' .. msg.chat_id_, zain[2] or 50)
...
info = '👤┇العضو ~⪼ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'Tshake')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
local tsX_o = database:get("lock_tag:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التاك\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل التاك\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_tag:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الشارحه بالطرد") then
local tsX_o = database:get("lock_sarha:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الشارحه\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الشارحه\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_sarha:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الكلايش بالطرد") then
local tsX_o = database:get("lock_word:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الكلايش\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الكلايش\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_word:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل المتحركه بالطرد") then
local tsX_o = database:get("lock_gif:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل المتحركه\n🚫┇خاصية ~⪼ الطرد ")
else
tsX000("lock",msg,"☑┇ تم قفل المتحركه\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_gif:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الملفات بالطرد") then
local tsX_o = database:get("lock_files:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الملفات\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الملفات\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_files:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الماركدون بالطرد") then
local tsX_o = database:get("lock_mark:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الماركدون\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الماركدون\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_mark:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الصور بالطرد") then
local tsX_o = database:get("lock_photo:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الصور\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الصور\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_photo:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الملصقات بالطرد") then
local tsX_o = database:get("lock_stecker:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الملصقات\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الملصقات\n🚫┇خاصية ~⪼ الطرد ")
database:set("lock_stecker:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الفيديو بالطرد") then
local tsX_o = database:get("lock_video:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الفيديو\n🚫┇خاصية ~⪼ الطرد ")
else
tsX000("lock",msg,"☑┇ تم قفل الفيديو\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_video:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الانلاين بالطرد") then
local tsX_o = database:get("lock_inline:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الانلاين\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الانلاين\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_inline:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الدردشه بالطرد") then
local tsX_o = database:get("lock_chat:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الدردشه\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الدردشه\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_chat:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل التوجيه بالطرد") then
local tsX_o = database:get("lock_fwd:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التوجيه\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل التوجيه\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_fwd:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل التثبيت بالطرد") then
local tsX_o = database:get("lock_pin:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التثبيت\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل التثبيت\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_pin:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الاغاني بالطرد") then
local tsX_o = database:get("lock_audeo:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الاغاني\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الاغاني\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_audeo:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الصوت") then
local tsX_o = database:get("lock_voice:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الصوت \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الصوت \n🚫┇خاصية ~⪼ الطرد")
database:set("lock_voice:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الجهات بالطرد") then
local tsX_o = database:get("lock_contact:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الجهات\n🚫┇خاصية ~⪼ الطرد ")
else
tsX000("lock",msg,"☑┇ تم قفل الجهات\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_contact:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل العربيه بالطرد") then
local tsX_o = database:get("lock_ar:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل العربيه \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل العربيه \n🚫┇خاصية ~⪼ الطرد")
database:set("lock_ar:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الانكليزيه بالطرد") then
local tsX_o = database:get("lock_en:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الانكليزيه\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الانكليزيه\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_en:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الروابط بالطرد") then
local tsX_o = database:get("lock_link:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الروابط\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الروابط\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_link:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل المعرف بالطرد") then
local tsX_o = database:get("lock_username:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل المعرف\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل المعرف\n🚫┇خاصية ~⪼ الطرد")
database:set("lock_username:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الكل بالطرد") then
database:set("lock_tag:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_sarha:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_word:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_edit:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_lllll:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_gif:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_files:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_mark:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_photo:ban"..msg.chat_id_..bot_id,"ok")
...
database:set("lock_link:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_username:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_botAndBan:ban"..msg.chat_id_..bot_id,"ok")
database:set("lock_new:ban"..msg.chat_id_..bot_id,"ok")
tsX000("lock",msg,"☑┇ تم قفل جميع الاوامر \n🚫┇خاصية ~⪼ الطرد")
end
--         »»                 End Spirta lock                         ««              --
--         »»               Start Spirta unlock                       ««              --
if (text == "فتح الكل بالطرد") then
database:del("lock_tag:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_sarha:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_word:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_lllll:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_gif:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_files:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_mark:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_photo:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_stecker:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_video:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_audeo:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_voice:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_contact:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_fwd:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_link:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_username:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_botAndBan:ban"..msg.chat_id_..bot_id,"ok")
database:del("lock_new:ban"..msg.chat_id_..bot_id,"ok")
tsX000("lock",msg,"☑┇ تم فتح جميع الاوامر \n🚫┇خاصية ~⪼ الطرد")
end
if (text == "فتح التاك بالطرد") then
local tsX_o = database:get("lock_tag:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
if (text == "فتح الكلايش بالطرد") then
local tsX_o = database:get("lock_word:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الكلايش\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الكلايش\n🚫┇خاصية ~⪼ الطرد")
database:del("lock_word:ban"..msg.chat_id_..bot_id)
end
end

if (text == "فتح الشارحه بالطرد") then
local tsX_o = database:get("lock_sarha:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
if (text == "فتح المتحركه بالطرد") then
local tsX_o = database:get("lock_gif:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
if (text == "فتح الملفات بالطرد") then
local tsX_o = database:get("lock_files:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
if (text == "فتح الماركدون بالطرد") then
local tsX_o = database:get("lock_mark:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
if (text == "فتح الملصقات بالطرد") then
local tsX_o = database:get("lock_stecker:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
if (text == "فتح الفيديو بالطرد") then
local tsX_o = database:get("lock_video:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
if (text == "فتح الانلاين بالطرد") then
local tsX_o = database:get("lock_inline:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الانلاين\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الانلاين\n🚫┇خاصية ~⪼ الطرد")
database:del("lock_inline:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح التوجيه بالطرد") then
local tsX_o = database:get("lock_fwd:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
if (text == "فتح التثبيت بالطرد") then
local tsX_o = database:get("lock_pin:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح التثبيت\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح التثبيت\n🚫┇خاصية ~⪼ الطرد")
database:del("lock_pin:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح الاغاني بالطرد") then
local tsX_o = database:get("lock_audeo:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
if (text == "فتح الجهات بالطرد") then
local tsX_o = database:get("lock_contact:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
database:del("lock_ar:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح الانكليزيه بالطرد") then
local tsX_o = database:get("lock_en:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الانكليزيه\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الانكليزيه\n🚫┇خاصية ~⪼ الطرد")
database:del("lock_en:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح المعرف بالطرد") then
local tsX_o = database:get("lock_username:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
if (text == "فتح الروابط بالطرد") then
local tsX_o = database:get("lock_link:ban"..msg.chat_id_..bot_id)
if not tsX_o then
...
--------Lock--wern-------
if (text == "قفل التاك بالتحذير") then
local tsX_o = database:get("lock_tag:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التاك\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل التاك\n📛┇خاصية ~⪼ التحذير")
database:set("lock_tag:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الشارحه بالتحذير") then
local tsX_o = database:get("lock_sarha:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الشارحه\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الشارحه\n📛┇خاصية ~⪼ التحذير")
database:set("lock_sarha:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الكلايش بالتحذير") then
local tsX_o = database:get("lock_word:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الكلايش\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الكلايش\n📛┇خاصية ~⪼ التحذير")
database:set("lock_word:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل المتحركه بالتحذير") then
local tsX_o = database:get("lock_gif:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل المتحركه\n📛┇خاصية ~⪼ التحذير ")
else
tsX000("lock",msg,"☑┇ تم قفل المتحركه\n📛┇خاصية ~⪼ التحذير")
database:set("lock_gif:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الملفات بالتحذير") then
local tsX_o = database:get("lock_files:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الملفات\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الملفات\n📛┇خاصية ~⪼ التحذير")
database:set("lock_files:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الماركدون بالتحذير") then
local tsX_o = database:get("lock_mark:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الماركدون\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الماركدون\n📛┇خاصية ~⪼ التحذير")
database:set("lock_mark:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الصور بالتحذير") then
local tsX_o = database:get("lock_photo:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الصور\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الصور\n📛┇خاصية ~⪼ التحذير")
database:set("lock_photo:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الملصقات بالتحذير") then
local tsX_o = database:get("lock_stecker:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الملصقات\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الملصقات\n📛┇خاصية ~⪼ التحذير ")
database:set("lock_stecker:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الفيديو بالتحذير") then
local tsX_o = database:get("lock_video:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الفيديو\n📛┇خاصية ~⪼ التحذير ")
else
tsX000("lock",msg,"☑┇ تم قفل الفيديو\n📛┇خاصية ~⪼ التحذير")
database:set("lock_video:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الانلاين بالتحذير") then
local tsX_o = database:get("lock_inline:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الانلاين\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الانلاين\n📛┇خاصية ~⪼ التحذير")
database:set("lock_inline:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الدردشه بالتحذير") then
local tsX_o = database:get("lock_chat:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الدردشه\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الدردشه\n📛┇خاصية ~⪼ التحذير")
database:set("lock_chat:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل التوجيه بالتحذير") then
local tsX_o = database:get("lock_fwd:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التوجيه\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل التوجيه\n📛┇خاصية ~⪼ التحذير")
database:set("lock_fwd:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل التثبيت بالتحذير") then
local tsX_o = database:get("lock_pin:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التثبيت\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل التثبيت \n📛┇خاصية ~⪼ التحذير")
database:set("lock_pin:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الاغاني بالتحذير") then
local tsX_o = database:get("lock_audeo:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الاغاني\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الاغاني\n📛┇خاصية ~⪼ التحذير")
database:set("lock_audeo:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الصوت") then
local tsX_o = database:get("lock_voice:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الصوت \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الصوت \n📛┇خاصية ~⪼ التحذير")
database:set("lock_voice:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الجهات بالتحذير") then
local tsX_o = database:get("lock_contact:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الجهات\n📛┇خاصية ~⪼ التحذير ")
else
tsX000("lock",msg,"☑┇ تم قفل الجهات\n📛┇خاصية ~⪼ التحذير")
database:set("lock_contact:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل العربيه") then
local tsX_o = database:get("lock_ar:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل العربيه \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل العربيه \n📛┇خاصية ~⪼ التحذير")
database:set("lock_ar:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الانكليزيه بالتحذير") then
local tsX_o = database:get("lock_en:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الانكليزيه\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الانكليزيه\n📛┇خاصية ~⪼ التحذير")
database:set("lock_en:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الروابط بالتحذير") then
local tsX_o = database:get("lock_link:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الروابط\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الروابط\n📛┇خاصية ~⪼ التحذير")
database:set("lock_link:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل المعرف بالتحذير") then
local tsX_o = database:get("lock_username:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل المعرف\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل المعرف\n📛┇خاصية ~⪼ التحذير")
database:set("lock_username:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الكل بالتحذير") then
database:set("lock_tag:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_sarha:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_word:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_edit:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_lllll:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_gif:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_files:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_mark:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_photo:wern"..msg.chat_id_..bot_id,"ok")
...
database:set("lock_link:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_username:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_botAndBan:wern"..msg.chat_id_..bot_id,"ok")
database:set("lock_new:wern"..msg.chat_id_..bot_id,"ok")
tsX000("lock",msg,"☑┇ تم قفل جميع الاوامر \n📛┇خاصية ~⪼ التحذير")
end
--         »»                 End Spirta lock                         ««              --
--         »»               Start Spirta unlock                       ««              --
if (text == "فتح الكل بالتحذير") then
database:del("lock_tag:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_sarha:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_word:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_lllll:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_gif:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_files:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_mark:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_photo:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_stecker:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_video:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_audeo:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_voice:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_contact:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_fwd:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_link:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_username:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_botAndBan:wern"..msg.chat_id_..bot_id,"ok")
database:del("lock_new:wern"..msg.chat_id_..bot_id,"ok")
tsX000("lock",msg,"☑┇ تم فتح جميع الاوامر \n📛┇خاصية ~⪼ التحذير")
end
if (text == "فتح التاك بالتحذير") then
local tsX_o = database:get("lock_tag:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح التاك\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح الكلايش بالتحذير") then
local tsX_o = database:get("lock_word:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الكلايش\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الكلايش\n📛┇خاصية ~⪼ التحذير")
database:del("lock_word:wern"..msg.chat_id_..bot_id)
end
end

if (text == "فتح الشارحه بالتحذير") then
local tsX_o = database:get("lock_sarha:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الشارحه\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح المتحركه بالتحذير") then
local tsX_o = database:get("lock_gif:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح المتحركه\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح الملفات بالتحذير") then
local tsX_o = database:get("lock_files:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الملفات\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح الماركدون بالتحذير") then
local tsX_o = database:get("lock_mark:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الماركدون\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح الصور بالتحذير") then
local tsX_o = database:get("lock_photo:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الصور\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح الملصقات بالتحذير") then
local tsX_o = database:get("lock_stecker:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الملصقات\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح الفيديو بالتحذير") then
local tsX_o = database:get("lock_video:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الفيديو\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح الانلاين بالتحذير") then
local tsX_o = database:get("lock_inline:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الانلاين\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الانلاين\n📛┇خاصية ~⪼ التحذير")
database:del("lock_inline:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح التوجيه بالتحذير") then
local tsX_o = database:get("lock_fwd:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح التوجيه\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح التثبيت بالتحذير") then
local tsX_o = database:get("lock_pin:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح التثبيت\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح التثبيت\n📛┇خاصية ~⪼ التحذير")
database:del("lock_pin:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح الاغاني بالتحذير") then
local tsX_o = database:get("lock_audeo:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الاغاني\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح الجهات بالتحذير") then
local tsX_o = database:get("lock_contact:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الجهات\n📛┇خاصية ~⪼ التحذير")
else
...
tsX000("lock",msg,"☑┇تم فتح العربيه \n📛┇خاصية ~⪼ التحذير")
database:del("lock_ar:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح الانكليزيه بالتحذير") then
local tsX_o = database:get("lock_en:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الانكليزيه\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الانكليزيه\n📛┇خاصية ~⪼ التحذير")
database:del("lock_en:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح المعرف بالتحذير") then
local tsX_o = database:get("lock_username:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح المعرف\n📛┇خاصية ~⪼ التحذير")
else
...
if (text == "فتح الروابط بالتحذير") then
local tsX_o = database:get("lock_link:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الروابط\n📛┇خاصية ~⪼ التحذير")
else
...
return false end
function promote_by_reply(extra, result, success)
local hash =  'Tshake:'..bot_id..'sakl:'..msg.chat_id_
if database:sismember(hash, result.sender_user_id_) then
...
return false end
function promote_by_reply(extra, result, success)
local hash =  'Tshake:'..bot_id..'zain:'..msg.chat_id_
if database:sismember(hash, result.sender_user_id_) then
...
return false end
function promote_by_reply(extra, result, success)
local hash =  'Tshake:'..bot_id..'donke:'..msg.chat_id_
if database:sismember(hash, result.sender_user_id_) then
...
return false end
function promote_by_reply(extra, result, success)
local hash =  'Tshake:'..bot_id..'zahf:'..msg.chat_id_
if database:sismember(hash, result.sender_user_id_) then
...
return false end
function promote_by_reply(extra, result, success)
local hash =  'Tshake:'..bot_id..'doq:'..msg.chat_id_
if database:sismember(hash, result.sender_user_id_) then
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apba[2] or 'Tshake')..')\n☑┇تم حظره من المجموعه'
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apsi[2] or 'Tshake')..')\n🚫┇تم كتمه من البوت'
end
else
texts = '✖┇خطاء'
end
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apki[2] or 'Tshake')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖┇خطاء'
...
for k,v in pairs(list) do  
local zain = database:get('Tshake:'..bot_id.."filtr1:add:reply:rd"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..zain..'}\n'    
end  
if #list == 0 then  
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(res[2] or 'Tshake')..')\n☑️┇تم تقييده'
end
else
texts = '✖️┇خطاء'
end
...
local Spirta = '🗑 ┇ تم حذف سحكاتك '
send(msg.chat_id_, msg.id_, 1, Spirta, 1, 'md')
end
------------------------------------------------------------------------
if text == ("اطردني") then
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=GLOBLA&user_id="..msg.sender_user_id_);
...
------------------------------------------------------------------------
if (text and text == (redis:get('Tshake:'..bot_id..'name_bot') or 'سبارتا'))then
name_bot = (redis:get('Tshake:'..bot_id..'name_bot') or 'سبارتا')
local namebot = {
...
local nzain = redis:get('Tshake:'..bot_id..'nmzain')
local nazain = redis:get('Tshake:'..bot_id..'nazain')
if text_sudo then
...
t = database:get("Tshake:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_)
elseif is_owner(msg) then
t = database:get("Tshake:name_own"..bot_id..msg.chat_id_) or 'مدير الكروب 👮‍♂️'   
elseif is_mod(msg) then
t = database:get("Tshake:name_adm"..bot_id..msg.chat_id_) or 'ادمن الكروب👩🏿‍🚒'  
elseif is_vip(msg) then
t = database:get("Tshake:name_vipp"..bot_id..msg.chat_id_) or ' عضو مميز 🧙🏻‍♂'
...
local Tshake_new_text = Tshake_new_text:gsub('#auto',(izain_text or 'لا يوجد'))
...
------------------------------------------------------------------------
if text == 'معاني' and database:get('Tshake:'..bot_id..'lock_geam'..msg.chat_id_) then
...
zain = '*💎┇ عدد مجوهراتك الحاليه  ('..(database:get('Tshake:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_))..')*'
zain1 = '*💎┇ مجموع مجوهراتك  ('..(database:get('Tshake:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))..')*'
...
zain = (database:get('Tshake:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) * tonumber(database:get('Tshake:'..bot_id..'gamepoint' .. msg.chat_id_)or 50))
database:incrby('Tshake:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_,zain)  
database:del('Tshake:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_)
zain = tonumber((database:get('Tshake:'..bot_id..'gamepoint' .. msg.chat_id_) or 50))
...
------------------------------------------------------------------------
if text == "م3" or text == "م٣" and is_mod(msg) then
local hres = redis:get('Tshake:'..bot_id..'hres')
local text =[[
📮┇ اوامر حمايه المجموعه بالتقييد والطرد
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
🔒┇قفل ، فتح  ~⪼ الامر
...
local h6 = redis:get('Tshake:'..bot_id..'h6')
local text =  [[
🎖┇اوامر المطور
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
✳️┇تفعيل/تعطيل
...
if text == ("اوامر تحشيش") or text == ("اوامر التحشيش") then
local text =  [[
😹┇اوامر تحشيش البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
🐴┇رفع / تنزيل مطي 
...
local Name_Bot = (redis:get('Tshake:'..bot_id..'name_bot') or 'سبارتا')
...
send(msg.chat_id_,0, 1, "[⚠┇#تحذير] \n☑┇قام شخصآ ما في المجموعه بالتعديل على الميديا يرجى الانتباه \n📫┇الشخص الي قام بالتعديل \n ["..data.first_name_.."](T.ME/Spirta)" , 1, 'md') 
end
end
getUser(result.sender_user_id_,get_edit)
delete_msg(msg.chat_id_,{[0] = msg.message_id_}) 
elseif database:get("lock_edit:Spirta:kick"..msg.chat_id_..bot_id) and not result.content_.text_ and not is_creator(msgg) and not is_creatorbasic(msgg) then
function get_edit(arg,data)
local username = data.username_
local name = data.first_name_
local iduser = data.id_
...
------------------------------------------------------------------------
local zain = database:get('Tshake:'..bot_id.."add:reply:rd"..text..msg.chat_id_)   
